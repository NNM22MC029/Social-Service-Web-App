  ...
  return (
    <HEADER>
      <header>
        <Link to="/">
          {' '}
          <img className="logo" alt="logo" src={DASHDONATION} />{' '}
        </Link>
        ...
        <div className={'secNav'}>
          ...
          <div className="navIcons">
            ...
            <Link to="/cart">{/* <Icon as={BsHandbag}/> */}</Link>
            {token ? (
              <Menu>
                {({ isOpen }) => (
                  <div>
                    <MenuButton isActive={isOpen} as={Button}>
                      {isOpen ? (
                        <Icon size={30} as={CgProfile} />
                      ) : (
                        <Icon as={CgProfile} size={30} />
                      )}
                    </MenuButton>
                    <MenuList
              ...
              <Menu>
                {({ isOpen }) => (
                  <div>
                    <MenuButton isActive={isOpen} as={Button}>
                      {isOpen ? (
                        <Icon size={30} as={FiLogIn} />
                      ) : (
                        <Icon as={FiLogIn} size={30} />
                      )}
                    </MenuButton>
                    <MenuList
                      style={{ display: 'flex', flexDirection: 'column' }}
